...
public class PmsOssController {
    String accessId = "LTAI4Fsigdh5bkkBW4K7vAwL"; // 请填写您的AccessKeyId。
    String accessKey = "Jwff5C5C3qJdJD7uLZVDf2a8oYAZBD"; // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
    String bucket = "xin-gmall"; // 请填写您的 bucketname 。
