...
public class WareSkuController {
    ...
    @GetMapping("{skuId}")
    public Resp<List<WareSkuEntity>> queryWareSkuBySkuId(@PathVariable(value = "skuId") Long skuId) {
        List<WareSkuEntity> wareInfoEntities = this.wareSkuService.list(new QueryWrapper<WareSkuEntity>().eq("sku_id", skuId));
        return Resp.ok(wareInfoEntities);
    }
